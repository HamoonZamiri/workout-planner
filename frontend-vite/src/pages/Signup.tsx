...
const Signup = () => {
    ...
    const checkPassword = () => {
        ...
        return {minLength, hasLowercase, hasUppercase, hasNumber, hasSpecial, matchingPassword};
    }

    const {minLength, hasLowercase, hasUppercase, hasNumber, hasSpecial, matchingPassword} = checkPassword();
        ...
        <div className="w-full flex flex-col items-center">
            ...
            <form className="w-4/5 sm:w-2/5" onSubmit={handleSubmit}>
                ...
                <ul className="list-disc list-inside mb-4 text-xs sm:text-base">
                    <li className={!minLength ? "text-red-500" : "text-green-500"}>Have a minimum length of 8</li>
                    <li className={!hasLowercase ? "text-red-500" : "text-green-500"}>Have one lowercase character</li>
                    <li className={!hasUppercase ? "text-red-500" : "text-green-500"}>Have one uppercase character</li>
                    <li className={!hasNumber ? "text-red-500" : "text-green-500"}>Have one number</li>
                    <li className={!hasSpecial ? "text-red-500" : "text-green-500"}>Have one special character (!, @, #, $, %, ^, &, *)</li>
                    <li className={!matchingPassword ? "text-red-500" : "text-green-500"}>Match the confirmed password</li>
                </ul>
