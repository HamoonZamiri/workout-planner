...
var clientMap = make(map[string]*clients.SocketClient)
...
func closeConnection(client *clients.SocketClient) {
	client.CloseConn()
...
func main() {
	http.HandleFunc("/echo", func(w http.ResponseWriter, r *http.Request) {
		...
		socketClient := clients.New(conn, userId)
		...
		for {
			...
			if err != nil {
				fmt.Println(err, "Problem parsing json message")
			}
